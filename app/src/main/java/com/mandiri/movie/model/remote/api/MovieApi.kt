package com.mandiri.movie.model.remote.api
...
interface MovieApi {
    ...
    @GET("/3/movie/{$PATH_MOVIE_ID}/reviews")
    suspend fun getReviews(@Path(PATH_MOVIE_ID) movieId: String, @Query(QUERY_API_KEY) apiKey: String, @Query(QUERY_LANGUAGE) language: String?): ReviewList
